...
<div class="page-footer">
    <div class="page-footer-inner"> <?=date('Y')?> &copy; Biyinzika Web Admin Panel By
        <a target="_blank" href="http://rythtech.com">Rythtech Ltd</a>
    </div>
...
<script src="<?=base_url('assets/dist/jquery.validate.js')?>" type="text/javascript"></script>
<script src="<?=base_url('assets/pages/scripts/dashboard.min.js')?>" type="text/javascript"></script>
<script src="<?=base_url('assets/dist/jquery.mask.min.js')?>" type="text/javascript"></script>
